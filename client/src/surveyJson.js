    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          elements: [
              ...
              elements: [
                {
                  type: "text",
                  name:
                    "case_identifier_information_patient_date_of_birth_date",
                  visibleIf:
                    "{case_identifier_information_patient_date_of_birth_checkbox} empty",
                  titleLocation: "hidden",
                  inputType: "date",
                },
                {
                  type: "checkbox",
                  name:
                    "case_identifier_information_patient_date_of_birth_checkbox",
                  startWithNewLine: false,
                  titleLocation: "hidden",
                  choices: ["Unknown"],
                },
            ...
            },
            {
              type: "text",
              name:
                "case_identifier_information_patient_telephone_mobile_number",
              ...
              elements: [
                {
                  ...
                  visibleIf:
                    "{case_identifier_information_patient_age_checkbox} empty",
                  title: "Years:",
                  titleLocation: "left",
                  inputType: "number",
                },
            ...
            },
            {
              type: "text",
              name:
                "case_identifier_information_patient_national_social_number",
              startWithNewLine: false,
          ...
          visibleIf:
            "{is_the_person_providing_the_information_is_the_patient} = true",
        ...
        },
        {
          type: "panel",
          name:
            "interview_respondent_information_if_the_persons_providing_the_information_is_not_the_patient",
          elements: [
            {
              type: "text",
              name: "first_name",
            ...
            },
            {
              type: "panel",
              name:
                "interview_respondent_information_patient_date_of_birth_panel",
              elements: [
                {
                  type: "text",
                  name:
                    "interview_respondent_information_patient_date_of_birth_date",
                  visibleIf:
                ...
                },
                {
                  type: "checkbox",
                  name:
                    "interview_respondent_information_patient_date_of_birth_checkbox",
                  startWithNewLine: false,
                  titleLocation: "hidden",
                  choices: ["Unknown"],
                },
            ...
            },
            {
              type: "text",
              name:
                "interview_respondent_information_patient_telephone_mobile_number",
              startWithNewLine: false,
              title: "Telephone (mobile) number",
              inputType: "tel",
            },
          ...
          visibleIf:
            "{is_the_person_providing_the_information_is_the_patient} = false",
                  ...
                  choices: [
                    {
                      ...
                      text: "No symptoms",
                      enableIf:
                        "{date_of_first_symptom_onset_checkbox} <> ['item2']",
                    },
                    {
                      value: "item2",
                      text: "Unknown",
                      enableIf:
                        "{date_of_first_symptom_onset_checkbox} <> ['item1']",
                    },
                  ],
                  colCount: 2,
                },
        ...
        },
        {
          ...
          elements: [
            ...
            },
            {
              type: "panel",
              name:
                "other_severe_or_life_threatening_illness_suggestive_of_an_infection_panel",
              elements: [
                {
                  type: "radiogroup",
                  name:
                    "other_severe_or_life_threatening_illness_suggestive_of_an_radio",
                  width: "49%",
                  titleLocation: "hidden",
                  choices: [
                    {
                ...
                },
                {
                  type: "text",
                  name:
                    "other_severe_or_life_threatening_illness_suggestive_of_an_specify",
                  enableIf:
              ...
              title:
                "Other severe or life-threatening illness suggestive of an infection",
            },
            {
              type: "radiogroup",
          ...
          elements: [
            {
              type: "panel",
              name:
                "have_you_travelled_within_the_last_days_domestically_panel",
              elements: [
                {
                  type: "radiogroup",
                  name:
                    "have_you_travelled_within_the_last_days_domestically_radio",
                  width: "50%",
                  titleLocation: "hidden",
                  choices: [
                    {
                ...
                },
                {
                  type: "panel",
                  name:
                    "have_you_travelled_within_the_last_days_domestically_date_panel",
                  elements: [
                    {
                      type: "text",
                      name:
                        "have_you_travelled_within_the_last_days_domestically_date_from",
                      title: "from",
                      titleLocation: "left",
                      inputType: "date",
                    },
                    {
                      type: "text",
                      name:
                        "have_you_travelled_within_the_last_days_domestically_date_to",
                      startWithNewLine: false,
                      title: "to",
                      titleLocation: "left",
                      inputType: "date",
                ...
                },
                {
                  type: "text",
                  name:
                    "have_you_travelled_within_the_last_days_domestically_regions",
                  visibleIf:
                    "{have_you_travelled_within_the_last_days_domestically_radio} = 'item1'",
                  title: "Regions:",
                  titleLocation: "left",
                },
                {
                  type: "text",
                  name:
                    "have_you_travelled_within_the_last_days_domestically_cities_visited",
                  visibleIf:
                    "{have_you_travelled_within_the_last_days_domestically_radio} = 'item1'",
                  startWithNewLine: false,
            ...
            },
            {
              type: "panel",
              name:
                "have_you_travelled_within_the_last_days_internationall_panel",
              elements: [
                {
                  type: "radiogroup",
                  name:
                    "have_you_travelled_within_the_last_days_internationall_radio",
                  width: "50%",
                  titleLocation: "hidden",
                  choices: [
                    {
                ...
                },
                {
                  type: "panel",
                  name:
                    "have_you_travelled_within_the_last_days_internationall_date_panel",
                  elements: [
                    {
                      type: "text",
                      name:
                        "have_you_travelled_within_the_last_days_internationall_date_from",
                      title: "from",
                      titleLocation: "left",
                      inputType: "date",
                    },
                    {
                      type: "text",
                      name:
                        "have_you_travelled_within_the_last_days_internationall_date_to",
                      startWithNewLine: false,
                      title: "to",
                      titleLocation: "left",
                      inputType: "date",
                ...
                },
                {
                  type: "text",
                  name:
                    "have_you_travelled_within_the_last_days_internationall_countries",
                  visibleIf:
                    "{have_you_travelled_within_the_last_days_internationall_radio} = 'item1'",
                ...
                },
                {
                  type: "text",
                  name:
                    "have_you_travelled_within_the_last_days_internationall_cities",
                  visibleIf:
                    "{have_you_travelled_within_the_last_days_internationall_radio} = 'item1'",
                  startWithNewLine: false,
                  title: "Cities visited:",
              ...
              title:
                "Have you travelled within the last 14 days internationally?",
              showQuestionNumbers: "off",
            },
            {
              type: "panel",
              name:
                "in_the_past_days_have_you_had_contact_with_a_anyone_with_suspected_or_confirmed_ncov_infection_panel",
              elements: [
                {
                  type: "radiogroup",
                  name:
                    "in_the_past_days_have_you_had_contact_with_a_anyone_with_suspected_or_confirmed_ncov_infection_radio",
                  width: "50%",
                  titleLocation: "hidden",
                  choices: [
                    {
                ...
                },
                {
                  type: "text",
                  name:
                    "in_the_past_days_have_you_had_contact_with_a_anyone_with_suspected_or_confirmed_ncov_infection_date",
                  enableIf:
            ...
            },
            {
              ...
              elements: [
                ...
                },
                {
                  ...
                  enableIf:
                    "{patient_attended_festival_or_mass_gathering_radio} = 'item1'",
                  startWithNewLine: false,
                  title: "Specify:",
                  titleLocation: "left",
                },
            ...
            },
            {
              type: "panel",
              name:
                "patient_visited_or_was_admitted_to_inpatient_health_facility_panel",
              elements: [
                {
                  type: "radiogroup",
                  name:
                    "patient_visited_or_was_admitted_to_inpatient_health_facility_radio",
                  width: "50%",
                  titleLocation: "hidden",
                  choices: [
                    {
                ...
                },
                {
                  type: "text",
                  name:
                    "patient_visited_or_was_admitted_to_inpatient_health_facility_specify",
                  enableIf:
                  ...
                  elements: [
                    {
                      type: "radiogroup",
                      name:
                        "patient_visited_outpatient_treatment_facility_radio",
                      width: "50%",
                      titleLocation: "hidden",
                      choices: [
                        {
                    ...
                    },
                    {
                      type: "text",
                      name:
                        "patient_visited_outpatient_treatment_facility_specify",
                      enableIf:
                        "{patient_visited_outpatient_treatment_facility_radio} = 'item1'",
                      startWithNewLine: false,
                      title: "Specify:",
                      titleLocation: "left",
                    },
                ...
                },
                {
                  ...
                  elements: [
                    ...
                    },
                    {
                      ...
                      enableIf:
                        "{patient_visited_traditional_healer_radio} = 'item1'",
                      startWithNewLine: false,
                      title: "Specify:",
                      titleLocation: "left",
                    },
                    {
                      type: "panel",
                      name:
                        "patient_occupation_specify_location_facility_panel",
                      elements: [
                        {
                          type: "checkbox",
                          name:
                            "patient_occupation_specify_location_facility_checkbox",
                          titleLocation: "hidden",
                          hasOther: true,
                          choices: [
                            {
                        ...
                        },
                        {
                          type: "text",
                          name:
                            "patient_occupation_specify_location_facility_specify",
                          visibleIf:
                            "{patient_occupation_specify_location_facility_checkbox} notempty",
                          title:
                            "For each occupation, please specify location or facility:",
                          titleLocation: "left",
                        },
                      ],
              ...
              title:
                "Patient visited or was admitted to inpatient health facility",
              showQuestionNumbers: "off",
            },
          ],
